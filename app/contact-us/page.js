    ...
    <main
      className={`min-h-screen transition-colors ${
        theme === 'white'
          ...
          : 'bg-[#14A3C7] text-white'
      }`}
    >
      <section
        className={`relative pt-32 pb-16 md:pt-40 md:pb-24 px-6 md:px-12 border-b transition-colors ${
          theme === 'white'
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-[10rem] font-serif font-black uppercase tracking-tighter leading-[0.85] mb-8 md:mb-12">
              ...
              <span
                className={theme === 'white' ? 'text-[#14A3C7]' : 'text-black'}
              >
      ...
      <section
        className={`py-16 md:py-24 px-6 md:px-12 border-t transition-colors ${
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-5 space-y-16">
            <div className="space-y-8">
              ...
              />
              <p
                className={`font-medium leading-relaxed max-w-sm ${
            ...
            <div className="space-y-10">
              <div className="flex gap-6 group">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center group-hover:bg-[#14A3C7] group-hover:text-white transition-all duration-300 ${
                    theme === 'white'
                      ? 'bg-black/5 text-[#14A3C7]'
              ...
              <div className="flex gap-6 group">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center text-[#14A3C7] group-hover:bg-[#14A3C7] group-hover:text-white transition-all duration-300 ${
                    theme === 'white' ? 'bg-black/5' : 'bg-white/5'
                  }`}
                >
                  <Mail size={24} />
                </div>
          ...
          <div className="lg:col-span-7">
            <div
              className={`p-8 md:p-12 border rounded-[3rem] backdrop-blur-xl transition-colors ${
                theme === 'white'
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full border-b p-4 focus:border-[#14A3C7] outline-none transition-colors font-bold ${
                        theme === 'white'
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className={`w-full border-b p-4 focus:border-[#14A3C7] outline-none transition-colors font-bold resize-none ${
                      theme === 'white'
                        ? 'bg-black/5 border-black/10 placeholder:text-black/50 text-black'
                        : 'bg-white/5 border-white/10 placeholder:text-white/40 text-white'
                    }`}
